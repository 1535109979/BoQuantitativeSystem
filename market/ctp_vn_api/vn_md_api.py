...
class VnMdApi(MdApi):
    ...
    def __init__(self, gateway) -> None:
        ...
        self.configs = self.gateway.get_api_configs()
    ...
    def subscribe(self, need_sub = ['rb2509']) -> None:
        """订阅行情"""
    ...
    def onRtnDepthMarketData(self, data: dict) -> None:
        """行情数据推送"""
        """
        {'TradingDay': '20250606', 'reserve1': '', 'ExchangeID': '', 'reserve2': '', 'LastPrice': 2966.0, 'PreSettlementPrice': 2948.0, 
        'PreClosePrice': 2946.0, 'PreOpenInterest': 268952.0, 'OpenPrice': 2946.0, 'HighestPrice': 2983.0, 'LowestPrice': 2946.0, 
        'Volume': 34745, 'Turnover': 1030454970.0, 'OpenInterest': 269692.0, 'ClosePrice': 1.7976931348623157e+308, 
        'SettlementPrice': 1.7976931348623157e+308, 'UpperLimitPrice': 3095.0, 'LowerLimitPrice': 2800.0, 'PreDelta': 0.0, 
        'CurrDelta': 1.7976931348623157e+308, 'UpdateTime': '16:55:06', 'UpdateMillisec': 500, 'BidPrice1': 2965.0, 'BidVolume1': 65, 
        'AskPrice1': 2966.0, 'AskVolume1': 70, 'BidPrice2': 1.7976931348623157e+308, 'BidVolume2': 0, 
        'AskPrice2': 1.7976931348623157e+308, 'AskVolume2': 0, 'BidPrice3': 1.7976931348623157e+308, 'BidVolume3': 0, 
        'AskPrice3': 1.7976931348623157e+308, 'AskVolume3': 0, 'BidPrice4': 1.7976931348623157e+308, 'BidVolume4': 0, 
        'AskPrice4': 1.7976931348623157e+308, 'AskVolume4': 0, 'BidPrice5': 1.7976931348623157e+308, 'BidVolume5': 0, 
        'AskPrice5': 1.7976931348623157e+308, 'AskVolume5': 0, 'AveragePrice': 29657.647719096272, 'ActionDay': '20250605', 
        'InstrumentID': 'rb2509', 'ExchangeInstID': '', 'BandingUpperPrice': 0.0, 'BandingLowerPrice': 0.0}
        """

        localtime = datetime.strptime(f'{data["TradingDay"]} {data["UpdateTime"]}',
                                      "%Y%m%d %H:%M:%S").timestamp()
        quote = {
            'symbol': data['InstrumentID'],
            'localtime': localtime,
            'strptime': f'{data["TradingDay"]} {data["UpdateTime"]}',
